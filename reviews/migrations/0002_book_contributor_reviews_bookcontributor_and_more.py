# Generated by Django 4.1.4 on 2023-03-06 11:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.TextField(help_text='The title of the book.', max_length=70)),
                ('publication_date', models.DateField(verbose_name='Date of the book was published')),
            ],
        ),
        migrations.CreateModel(
            name='Contributor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('AUTHOR', 'Author'), ('CO_AUTHOR', 'Co-Author'), ('EDITOR', 'Editor')], max_length=20, verbose_name='The role of the contributor for the book')),
